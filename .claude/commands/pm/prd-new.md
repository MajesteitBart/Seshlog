---
description: Launch brainstorming for new product requirement document
...
2. **Check for existing PRD:**
   - Check if `.project/prds/$ARGUMENTS.md` already exists
...
3. **Verify directory structure:**
   - Check if `.project/prds/` directory exists
   - If not, create it first
   - If unable to create, tell user: "❌ Cannot create PRD directory. Please manually create: .project/prds/"
...
Save the completed PRD to: `.project/prds/$ARGUMENTS.md` with this exact structure:
...
- **status**: Always start with "draft" for new PRDs
...
1. Confirm: "✅ PRD created: .project/prds/$ARGUMENTS.md"
