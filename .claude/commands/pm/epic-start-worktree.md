...
Follow `.claude/rules/worktree-operations.md`:
...
- Follow `.claude/rules/worktree-operations.md` for git operations
- Follow `.claude/rules/agent-coordination.md` for parallel work
