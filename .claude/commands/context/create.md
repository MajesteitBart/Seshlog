---
description: Create initial project context documentation in .project/context/
allowed-tools: Bash, Read, Write, LS
---

# Create Initial Context

This command creates the initial project context documentation in `.project/context/` by analyzing the current project state and establishing comprehensive baseline documentation.
...
- Run: `ls -la .project/context/ 2>/dev/null`
- If directory exists and has files:
  - Count existing files: `ls -1 .project/context/*.md 2>/dev/null | wc -l`
...
- If `.project/` doesn't exist, create it: `mkdir -p .project/context/`
- Verify write permissions: `touch .project/context/.test && rm .project/context/.test`
...
**Common Issues:**
- **No write permissions:** "❌ Cannot write to .project/context/. Check permissions."
...
📁 Created context in: .project/context/
...
- Target directory: `.project/context/` (create if needed)
