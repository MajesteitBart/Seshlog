---
description: Update project context documentation in .project/context/ with recent changes
allowed-tools: Bash, Read, Write, LS
---

# Update Context

This command updates the project context documentation in `.project/context/` to reflect the current state of the project. Run this at the end of each development session to keep context accurate.
...
**File Modifications:**
- Check context file ages: `find .project/context -name "*.md" -type f -exec ls -lt {} + | head -5`
