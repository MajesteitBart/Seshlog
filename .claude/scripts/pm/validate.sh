...
[ -d ".project/prds" ] && echo "  ✅ PRDs directory exists" || echo "  ⚠️ PRDs directory missing"
[ -d ".project/epics" ] && echo "  ✅ Epics directory exists" || echo "  ⚠️ Epics directory missing"
...
orphaned=$(find .claude -name "[0-9]*.md" -not -path ".project/epics/*/*" 2>/dev/null | wc -l)
...
for task_file in .project/epics/*/[0-9]*.md; do
