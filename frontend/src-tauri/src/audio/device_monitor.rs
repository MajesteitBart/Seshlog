...
impl AudioDeviceMonitor {
    ...
    pub fn start_monitoring(
        ...
        if let Some(mic) = microphone {
            ...
            info!("ðŸ” Monitoring microphone: '{}' (Bluetooth: {})",
        ...
        if let Some(sys) = system_audio {
            ...
            info!("ðŸ” Monitoring system audio: '{}' (Bluetooth: {})",
        ...
        info!("âœ… Device monitor started");
        Ok(())
    }
            ...
            for monitored in &mut monitored_devices {
                ...
                if device_found {
                    ...
                    if monitored.consecutive_missing > 0 {
                        ...
                        info!("âœ… Device '{}' reconnected after {} missing checks",
                    ...
                    debug!("âš ï¸ Device '{}' missing for {} checks (threshold: {})",
                          monitored.name, monitored.consecutive_missing,
