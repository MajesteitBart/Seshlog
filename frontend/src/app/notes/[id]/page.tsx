...
const NotePage = ({ params }: PageProps) => {
  ...
  const sampleData: Record<string, Note> = {
    'team-sync-dec-26': {
      ...
      attendees: ['Attendee A', 'Attendee B', 'Attendee C'],
...
## Action Items
- [ ] Attendee A: Create project timeline
- [ ] Attendee B: Schedule design review meetings
- [ ] Attendee C: Update documentation
...
- Planned resource allocation for upcoming sprint
    ...
    'product-review': {
      ...
      attendees: ['Attendee D', 'Attendee E', 'Attendee F'],
