              ...
              {showPlayback ? (
                <>
                  <button
                    ...
                    className="w-10 h-10 flex items-center justify-center bg-primary rounded-full text-white hover:bg-accent transition-colors"
                  >
                    <Mic size={16} />
                  </button>
                ...
                <>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className={`w-12 h-12 flex items-center justify-center ${isStarting || isProcessing || isValidatingModel ? 'bg-gray-400' : 'bg-primary hover:bg-accent'
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className={`w-10 h-10 flex items-center justify-center ${isStopping || isPausing || isResuming ? 'bg-gray-400' : 'bg-recording hover:bg-recording/80'
                              } rounded-full text-white transition-colors relative`}
                          >
                            <Square size={16} />
                            {isStopping && (
                  ...
                  <div className="flex items-center space-x-1 mx-4">
                    {barHeights.map((height, index) => (
                      <div
                        key={index}
                        className={`w-1 rounded-full transition-all duration-200 ${isPaused ? 'bg-orange-500' : 'bg-recording'
                          }`}
                        style={{
