...
export function ChunkProgressDisplay({
  ...
  const getChunkStatusColor = (status: ChunkStatus['status']) => {
    switch (status) {
      ...
      case 'processing':
        return 'text-processing bg-processing/10 border-processing/20';
      case 'failed':
    ...
    <div className={`bg-white border border-gray-200 rounded-lg p-4 ${className}`}>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            onClick={onCancel}
            className="bg-destructive hover:bg-destructive/90 text-white px-3 py-1 rounded text-sm transition-colors"
          >
            Cancel
          </button>
        </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-4 text-sm">
        ...
        <div className="text-center">
          <div className="text-lg font-semibold text-processing">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {chunk.status === 'processing' && (
                    <div className="flex items-center space-x-1">
                      <div className="animate-spin w-3 h-3 border border-processing border-t-transparent rounded-full"></div>
                    </div>
                  )}
                </div>
    ...
    <div className={`bg-gray-50 border border-gray-200 rounded-lg p-3 ${className}`}>
      ...
      <div className="text-xs text-gray-600">
        ...
        {progress.processing_chunks > 0 && (
          <span className="ml-2 text-processing">
