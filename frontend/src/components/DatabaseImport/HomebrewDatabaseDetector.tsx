...
export function HomebrewDatabaseDetector({ onImportSuccess, onDecline }: HomebrewDatabaseDetectorProps) {
  ...
  return (
    <div className="mb-4 p-4 bg-primary/5 border-2 border-primary/30 rounded-lg">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleNo}
              disabled={isImporting}
              className="flex-1 px-4 py-2 border-2 border-primary/40 text-primary rounded-lg hover:bg-primary/10 disabled:bg-gray-100 disabled:cursor-not-allowed transition-colors"
            >
              No, Browse Manually
            </button>
          </div>
