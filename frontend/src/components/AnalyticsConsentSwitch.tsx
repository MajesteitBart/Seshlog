      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mb-4">
            Help us improve Seshlog by sharing anonymous usage data. No personal content is collected—everything stays on your device.
          </p>
        </div>
        ...
        <div className="flex items-start gap-2 p-2 bg-primary/5 rounded border border-primary/20">
          ...
          <div className="text-xs text-primary">
            ...
            <button
              ...
              className="text-primary hover:text-accent underline hover:no-underline"
            >
              View Privacy Policy
            </button>
          </div>
