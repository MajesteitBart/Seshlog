        ...
        <Alert variant="destructive" className="border-amber-400 bg-amber-50">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            {isMacOS && !hasSystemAudio && (
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-primary hover:bg-accent rounded-md transition-colors"
              >
          ...
          <AlertDescription className="text-amber-800 mt-2">
            ...
            {!hasMicrophone && (
              <>
                <p className="mb-3">
                  Seshlog needs access to your microphone to record meetings. No microphone devices were detected.
                </p>
                ...
                {isMacOS && (
                  <div className="space-y-2 text-sm mb-4">
                    ...
                    <ul className="list-disc list-inside ml-2 space-y-1">
                      ...
                      <li>Grant Screen Recording permission to Seshlog</li>
